package xml.org.jsoup.select;

import xml.org.jsoup.helper.Validate;
import xml.org.jsoup.nodes.Comment;
import xml.org.jsoup.nodes.Document;
import xml.org.jsoup.nodes.DocumentType;
import xml.org.jsoup.nodes.Element;
import xml.org.jsoup.nodes.Node;
import xml.org.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<xml.org.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (xml.org.jsoup.nodes.Attribute attribute : values) {
    ...
    public static final class ContainsOwnText extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return (element.ownText().toLowerCase().contains(searchText.toLowerCase()));
        }
